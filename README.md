...
- Native, out-of-the-box **linear horizontal scalability** — achieved by workload partitioning, elegant distributed coordination, load-balanced workqueue support, etc. <sup>[Tell me more](https://avestic.dev/docs/horizontal-scalability)</sup>
