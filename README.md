...
- Single executable — no other deployment artifacts. Avesta applications always ship as one runnable program; we don't have multiple runnable projects (e.g. one for each background worker, etc.)
