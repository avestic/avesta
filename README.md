...
2. [**MongoDB**](https://www.mongodb.com/) (per-service — with sharding and replication support) as the source-of-truth event store (i.e. write model storage). (See [Why MongoDB]())
