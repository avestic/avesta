...
- Single executable — no other deployment artifacts. Avesta applications always ship as a singular runnable application; we don't have multiple runnable projects (e.g. per each background worker, etc.)
