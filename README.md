...
- Automated testing blueprint around behaviors/public API — black box testing
- Comprehensive snapshot-testing framework for writing fully in-process (read 'fast') unit tests for business logic, built on top of TUnit
